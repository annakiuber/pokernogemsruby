...
# 	hands = {"hand1" => hand1, "hand2" => hand2}
# 	assert_equal("hand2",handcomparison(hands))
# end

# def test_hand_comparrison_of_two_straightflush_reverse
# 	hand2 = ["2h", "3h", "4h", "5h", "6h"]
# 	hand1 = ["3h", "4h", "5h", "6h", "7h"]
# 	hands = {"hand1" => hand1, "hand2" => hand2}
# 	assert_equal("hand1",handcomparison(hands))
# end
...
# 	assert_equal("hand2 wins", handcomparison(hands))
# end
def test_pair_look_at_tie_hand2winner
	hand1 = ["Qs", "6d", "Qc", "2h", "7s"]
	hand2 = ["Ks", "Kh", "2c", "4d", "8s"]
	hands = {"hand1" => hand1, "hamd2" => hand2}
	assert_equal("hand2 wins", handcomparison(hands))
end

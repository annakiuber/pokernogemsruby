...
require_relative 'final_poker_nogems.rb'
...
###########################################
    ...
    def test_three_of_a_kind_beats_a_pair
		...
		def test_look_at_tie_one_pair_tie_two_kicker_card_ties
			hand1 = ["3h", "4c", "5d", "7d", "7c"]
        hand2 = ["2h", "4d", "5c", "7h", "7s"]
        assert_equal("Hand1 is the winner",look_at_tie(hand1,hand2))
    end
		def test_look_at_tie_one_pair_tie_three_kicker_card_ties
			hand1 = ["3h", "4c", "5d", "7d", "8c"]
        hand2 = ["3s", "4d", "5c", "7h", "8s"]
        assert_equal("split the pot",look_at_tie(hand1,hand2))
    end
		def test_look_at_tie_one_pair_tie_twothree_kicker_card_ties
			hand1 = ["3h", "4c", "5d", "7d", "7c"]
        hand2 = ["3s", "4d", "5c", "7h", "7s"]
        assert_equal("split the pot",look_at_tie(hand1,hand2))
    end
		def test_hand_comparison_one_pair_tie_two_kicker_card_ties
			hand1 = ["3h", "4c", "5d", "7d", "7c"]
				hand2 = ["2h", "4d", "5c", "7h", "7s"]
				hands = {"hand1" => hand1, "hand2" => hand2}
				assert_equal("Hand1 is the winner",hand_comparison(hands))
		end
		def test_hand_comparison_one_pair_tie_three_kicker_card_ties
			hand1 = ["3h", "4c", "5d", "7d", "8c"]
				hand2 = ["3s", "4d", "5c", "7h", "8s"]
				hands = {"hand1" => hand1, "hand2" => hand2}
				assert_equal("split the pot",hand_comparison(hands))
		end
		def test_hand_comparison_one_pair_tie_twothree_kicker_card_ties
			hand1 = ["3h", "4c", "5d", "7d", "7c"]
				hand2 = ["3s", "4d", "5c", "7h", "7s"]
				hands = {"hand1" => hand1, "hand2" => hand2}
				assert_equal("split the pot",hand_comparison(hands))
		...
		def test_hand_comparison_royal_flush_tie_same_face
...
def test_hand_comparison__flush_tie_same_face
	hand1 = ["5h", "6h", "7h", "8h", "9h"]
		hand2 = ["5s", "6s", "7s", "8s", "9s"]
		hands = {"hand1" => hand1, "hand2" => hand2}
		assert_equal("split the pot",hand_comparison(hands))
end
def test_hand_comparison__stright_tie_same_face
	hand1 = ["5h", "6h", "7h", "8c", "9h"]
		hand2 = ["5s", "6d", "7s", "8h", "9s"]
		hands = {"hand1" => hand1, "hand2" => hand2}
		assert_equal("split the pot",hand_comparison(hands))
end
def test_hand_comparison__twopair_tie_same_face
	hand1 = ["5h", "6h", "7h", "7c", "9d"]
		hand2 = ["5s", "5d", "7s", "8d", "9s"]
		hands = {"hand1" => hand1, "hand2" => hand2}
		assert_equal("hand1 wins",hand_comparison(hands))
end
